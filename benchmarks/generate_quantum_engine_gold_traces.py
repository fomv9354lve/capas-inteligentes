...
def main() -> None:
    ...
    for trace_id, fn, kwargs, coverage_case in TRACE_SPECS:
        ...
        audit_rows.append({
            ...
            "inference_blind_judge": "hold" if physical_level in {"analytic", "cross_sim", "estimated_bound"} else "no",
            "inference_correct": "unknown" if physical_level in {"analytic", "cross_sim", "estimated_bound"} else "no",
            ...
            "coverage_case": coverage_case,
            "risk_level": "low",
            "decision": "hold" if physical_level in {"analytic", "cross_sim", "estimated_bound"} else "reject",
            "notes": (
