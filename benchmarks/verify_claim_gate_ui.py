...
REQUIRED_SNIPPETS = [
    ...
    "capas-admissibility-calculus-v1",
    "controlled_reuse_meet",
    "training_reuse_meet",
    "reuse_boundary",
    "proof_obligations",
    ...
    "renderOperationalAction",
    "renderBatchResolution",
    "Batch resolution queue",
    "Decision to resolution path",
    "register_claim_type",
    "Schema errors",
    "Provenance",
    "Full output JSON",
    ...
    "batch-row-ft",
    "Batch training readiness preview",
    ...
    "must be booleans and must live at the payload root",
    "relative_anchor</code>, <code>empirical_anchor</code>, and <code>benchmark_anchor</code>",
    "claim-type-list",
    ...
    "programming_language_behavior_claim</code>: <code>language</code>",
    ...
    "Training readiness preview",
    "fine-tune-block",
    "renderFineTuneStatus",
    "aria-label=\"Training readiness preview status\"",
    ...
    "Pilot capacity model",
    "updateRoiCalculator",
    "roi-hours",
    "review capacity planning estimate",
    "CAPAS workflow",
    "Evidence contract",
    "builder-contract",
    "builder-preview",
    ...
    "Enter positive values to calculate the pilot capacity planning estimate",
...
FORBIDDEN_SNIPPETS = [
    ...
    "capas-transition-network-logo.svg",
    "topbar-logo-icon\" aria-hidden=\"true\"><img",
]
