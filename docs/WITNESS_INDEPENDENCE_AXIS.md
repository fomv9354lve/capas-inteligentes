...
| `theory_scaling_law_no_solver` | 5 | Theory-known scaling law or universal exponent; no computational witness, but fit/tolerance applies. | `trace_033`, `trace_034`, `trace_035`, `trace_036`, `trace_037`, `trace_038` |
