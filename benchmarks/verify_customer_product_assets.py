...
REQUIRED = {
    "landing page with narrative": (PRODUCT, ["Deterministic Claim Admissibility Engine", "Stop claim drift", "Run sample REWRITE", "Why claim admissibility?", "Contamination Cascade", "Why not a fact-checker or provenance tool?", "The moat"]),
    "landing page screenshots": (PRODUCT, ["CAPAS screenshot mock", "Claim drift example", "Association supported; causality not licensed"]),
    "product business case": (PRODUCT, ["Contamination Cascade", "nearly one third", "Audit artifact", "Example pilot corpus", "ACCEPT · 58%", "10k", "Modeling notes"]),
    ...
    "executive dashboard": (UI, ["Executive batch and provenance dashboard", "metric-ft-ready", "metric-provenance", "Batch fine-tune readiness"]),
    "pilot roi calculator": (UI, ["Pilot ROI calculator", "updateRoiCalculator", "roi-hours", "senior-review capacity redirected"]),
